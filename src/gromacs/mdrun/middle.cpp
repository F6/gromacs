/*! \internal \file
 *
 * \brief Implements the integrator for "middle" scheme
 *
...
{
    // ZhiZi: This is a simple test to see if the parameter can correctly 
    // reach this function here.
    // For now do_middle is identical to do_md, after confirming that
    // I have correctly added a new integrator, I will delete this
    // function and add a new one that actually implements the middle 
    // scheme.
    printf("do_middle called. However, it is identical with do_md for now.\n");
